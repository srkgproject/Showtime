...
const MOCK_MOVIES: Movie[] = [
  ...
  { id: '1', title: 'Cyber Runner 1049', poster: 'https://picsum.photos/300/450?random=1', banner: 'https://picsum.photos/1200/600?random=1', description: 'A futuristic noir thriller.', rating: 4.8, genre: ['Sci-Fi', 'Action'], duration: '2h 45m', language: ['English', 'Hindi'], cast: ['Ryan Gosling', 'Ana de Armas'], type: MovieType.NOW_SHOWING, theatreIds: ['t1', 't2'], trailerUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ' },
